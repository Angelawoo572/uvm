...
// Instantiate the BFM interfaces
  mii_rx_driver_bfm   mii_rx_drv_bfm(miim_if);
  mii_tx_driver_bfm   mii_tx_drv_bfm(miim_if);
...
// Connect interface to testbench virtual interface
  initial begin
    ...
    uvm_config_db #(virtual mii_rx_driver_bfm)::set(null, "uvm_test_top",
                                                    (INTERFACE_NAME == "") ? $sformatf("%m_RX_DRV_BFM") : $sformatf("%s_RX_DRV_BFM",INTERFACE_NAME),
                                                    mii_rx_drv_bfm);
    uvm_config_db #(virtual mii_tx_driver_bfm)::set(null, "uvm_test_top",
                                                    (INTERFACE_NAME == "") ? $sformatf("%m_TX_DRV_BFM") : $sformatf("%s_TX_DRV_BFM",INTERFACE_NAME),
                                                    mii_tx_drv_bfm);
  end
