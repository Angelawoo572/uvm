...
// Connect interface to testbench virtual interface
  ...
  initial begin
    ...
    uvm_config_db #(virtual mii_rx_driver_bfm)::set(null, "uvm_test_top", $sformatf("%s_rx_drv_bfm", interface_name), MII_rx_drv_bfm);
    uvm_config_db #(virtual mii_tx_driver_bfm)::set(null, "uvm_test_top", $sformatf("%s_tx_drv_bfm", interface_name), MII_tx_drv_bfm);
  end
