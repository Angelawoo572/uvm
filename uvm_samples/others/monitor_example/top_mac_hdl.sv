...
//
  ...
  initial begin
    ...
    uvm_config_db #(virtual mii_rx_driver_bfm)::set(null, "uvm_test_top", "MII_rx_drv_bfm", MII_rx_drv_bfm);
    uvm_config_db #(virtual mii_tx_driver_bfm)::set(null, "uvm_test_top", "MII_tx_drv_bfm", MII_tx_drv_bfm);
