...
module stimuli_fsm_tb();
    ...
    initial begin
        ...
        repeat(10) // e.g. addr < 32'hFFFF
            seq_fsm_inst.request_data(2'b0, 32'h0, 32'hFFFF);
        repeat(10) // e.g. addr > 32'h0000FFFF
            seq_fsm_inst.request_data(2'b0, 32'h0000FFFF, 32'hFFFFFFFF);
        repeat(20) // e.g. dist
            seq_fsm_inst.request_data(2'b1, 32'h0, 32'hFFFFFFFF);
        repeat(10) // e.g. parity
            seq_fsm_inst.request_data(2'd2, 32'h0, 32'hFFFFFFFF);
        repeat (10) // e.g. enum
            seq_fsm_inst.request_data(2'd3, 32'h0, 32'hFFFFFFFF);
